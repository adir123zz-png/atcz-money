...
const defaultCategories = [
  ...
  { name: 'מסעדות', icon: '🍽️', type: 'expense', sortOrder: 2, color: '#C05C00' },
  ...
  { name: 'ספורט', icon: '🏋️', type: 'expense', sortOrder: 9, color: '#3B82F6' },
  ...
  { name: 'מיסים', icon: '🏛️', type: 'expense', sortOrder: 13, color: '#DC2626' },
  ...
  { name: 'דמי שכירות', icon: '🏘️', type: 'income', sortOrder: 4, color: '#F59E0B' },
  { name: 'הטבות', icon: '🏛️', type: 'income', sortOrder: 5, color: '#EC4899' },
